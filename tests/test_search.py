...
def test_scheme_search(client: FlaskClient, page: PageActions, data_db: DataDBActions):
    ...
    page.read(html)
    page.assert_contains("Could not perform search as your form session has expired.")
    ...
    html = response.get_data(as_text=True)
    page.read(html)
    page.assert_contains(f'Found 4 schemes with title matching "{query["title"]}".')
    page.assert_lacks("Found 4 schemes in total.")
    ...
    html = response.get_data(as_text=True)
    page.read(html)
    page.assert_contains(f'Found 1 scheme with title matching "{query["title"]}".')
    page.assert_lacks("Found 1 scheme in total.")
    ...
    html = response.get_data(as_text=True)
    page.read(html)
    page.assert_contains(f'Found 1 scheme with identifier "{query["identifier"]}".')
    page.assert_lacks("Found 1 scheme in total.")
    ...
    html = response.get_data(as_text=True)
    page.read(html)
    page.assert_contains(f"Found 3 schemes related to {' and '.join(kws)}.")
    ...
    html = response.get_data(as_text=True)
    page.read(html)
    page.assert_contains(f"Found 2 schemes related to {' and '.join(kws)}.")
    ...
    html = response.get_data(as_text=True)
    page.read(html)
    page.assert_contains(f"No schemes found related to {' and '.join(kws)}.")
    ...
    html = response.get_data(as_text=True)
    page.read(html)
    page.assert_contains("Could not perform search as there was an error.")
    ...
    html = response.get_data(as_text=True)
    page.read(html)
    page.assert_contains(f'Found 2 schemes with funder matching "{query["funder"]}".')
    page.assert_contains(
        f'Found 2 schemes used with data of type "{query["dataType"]}".'
    )
    page.assert_contains("Found 3 schemes in total.")
    ...
    html = response.get_data(as_text=True)
    page.read(html)
    page.assert_contains(f'No funders found matching "{query["funder"]}".')
...
def test_subject_search(client: FlaskClient, page: PageActions, data_db: DataDBActions):
    ...
    html = response.get_data(as_text=True)
    page.read(html)
    page.assert_contains("<h1>Biological diversity</h1>")
    ...
    html = response.get_data(as_text=True)
    page.read(html)
    page.assert_contains("<h1>Information/library standards</h1>")
    ...
    html = response.get_data(as_text=True)
    page.read(html)
    page.assert_contains("<h1>Science</h1>")
    page.assert_contains("Found 3 schemes.")
    ...
    html = response.get_data(as_text=True)
    page.read(html)
    page.assert_contains("<h1>Geodynamics</h1>")
    ...
    html = response.get_data(as_text=True)
    page.read(html)
    page.assert_contains("<h1>Biosphere</h1>")
    page.assert_contains("No schemes have been associated with this subject area.")
    ...
    html = response.get_data(as_text=True)
    page.read(html)
    page.assert_contains("<h1>Wurzels</h1>")
    page.assert_contains('The subject "Wurzels" was not found in the thesaurus.')
...
def test_datatype_search(
    ...
    html = response.get_data(as_text=True)
    page.read(html)
    page.assert_contains("<h1>Dataset</h1>")
    ...
    html = response.get_data(as_text=True)
    page.read(html)
    page.assert_contains("<h1>Catalog</h1>")
    page.assert_contains(
...
def test_group_search(client: FlaskClient, page: PageActions, data_db: DataDBActions):
    ...
    html = response.get_data(as_text=True)
    page.read(html)
    page.assert_contains("<h1>Organization 1</h1>")
    ...
    page.read(html)
    page.assert_contains("<h1>Organization 1</h1>")
    page.assert_contains("No schemes found that are maintained by this organization.")
