...
class DataDBActions(object):
    def __init__(self, app: Flask):
        ...
        self.m1 = {
            ...
            "locations": [
                {"url": "https://website.org/m1", "type": "website"},
                {"url": "http://document.org/m1", "type": "document"},
            ],
            "namespaces": [{"prefix": "foo", "uri": "https://schemes.org/ns/foo#"}],
            "identifiers": [{"id": "10.1234/m1", "scheme": "DOI"}],
        }
        self.m2 = {
            "title": "Test scheme 2",
            "slug": "test-scheme-2",
            ...
            "versions": [
                {
                    ...
                    "valid": {"start": "2020-01-01", "end": "2022-01-01"},
                    "locations": [
                        {"url": "http://website.org/m2v1", "type": "website"},
                        {"url": "https://document.org/m2v1", "type": "document"},
                    ],
                    "samples": [
                        {
                    ...
                    "identifiers": [{"id": "10.1234/m2v1", "scheme": "DOI"}],
                },
                {
                    "number": "2.2",
                    "note": "<p>Paragraph 1.</p><p>Paragraph 2.</p>",
                    "valid": {"start": "2020-03-01", "end": "2022-01-01"},
                    "locations": [
                        {"url": "http://website.org/m2v2", "type": "website"},
                        {"url": "https://document.org/m2v2", "type": "document"},
                    ],
                    "identifiers": [{"id": "10.1234/m2v2", "scheme": "DOI"}],
                },
            ],
        }
        self.m3 = {
        ...
        self.t1 = {
            ...
            "locations": [
                {"url": "https://website.org/t1", "type": "website"},
                {"url": "http://documentation.org/t1", "type": "document"},
            ],
            "identifiers": [{"id": "10.1234/t1", "scheme": "DOI"}],
            "creators": [{"givenName": "Forename", "familyName": "Surname"}],
        }
        self.t2 = {
            "title": "Test tool 2",
            "slug": "test-tool-2",
            ...
            "versions": [
                {
                    ...
                    "issued": "2020-01-01",
                    "locations": [
                        {"url": "http://website.org/t2v1", "type": "website"},
                        {"url": "https://documentation.org/t2v1", "type": "document"},
                    ],
                    "identifiers": [{"id": "10.1234/t2v1", "scheme": "DOI"}],
                }
            ],
        }
        self.c1 = {
            ...
            "locations": [
                {"url": "https://library.org/c1", "type": "library (Python)"},
                {"url": "http://document.org/c1", "type": "document"},
            ],
            "identifiers": [{"id": "10.1234/c1", "scheme": "DOI"}],
            "creators": [
                {
                    "givenName": "Forename",
                    "familyName": "Surname",
            ...
            "versions": [
                {
                    ...
                    "issued": "2020-01-01",
                    "locations": [
                        {"url": "https://library.org/c2v1", "type": "library (Python)"},
                        {"url": "http://document.org/c2v1", "type": "document"},
                    ],
                    "identifiers": [{"id": "10.1234/c2v1", "scheme": "DOI"}],
                }
            ],
        }
        self.g1 = {
            ...
            "locations": [
                {"url": "http://website.org/g1", "type": "website"},
                {"url": "mailto:g1@website.org", "type": "email"},
            ],
            "identifiers": [
                {"id": "10.1234/g1", "scheme": "DOI"},
                {"id": "https://ror.org/002h8g185", "scheme": "ROR"},
            ],
        }
        self.e1 = {
            ...
            "description": "<p>Paragraph 1.</p><p>Paragraph 2.</p>",
            "creators": [{"fullName": "Corporation"}],
            "publication": "<i>IEEE MultiMedia</i>, 13(2), 84-88",
            "issued": "2017-12-31",
            "valid": {"start": "2018-01-01", "end": "2019-12-31"},
            "locations": [{"url": "http://journal.org/e1", "type": "document"}],
            "identifiers": [{"id": "10001.1234/e1", "scheme": "Handle"}],
        }
        self.rel1 = {
            "@id": "msc:e1",
        ...
        self.rel3 = {"@id": "msc:m1", "funders": ["msc:g1"]}
        self.rel4 = {"@id": "msc:m2", "parent schemes": ["msc:m1"], "users": ["msc:g1"]}
        self.rel5 = {"@id": "msc:t1", "supported schemes": ["msc:m3"]}
        self.rel6 = {"@id": "msc:m3", "funders": ["msc:g1"]}
        self.datatype1 = {
    ...
    def get_formdata(
        ...
        if version is not None:
            try:
                ...
                return MultiDict()
        kw_map = {
            "http://rdamsc.bath.ac.uk/thesaurus/subdomain235": "Earth sciences < Science",
            "http://vocabularies.unesco.org/thesaurus/concept4011": "Biological diversity < Ecological balance < Ecosystems <"
                    ...
                    if isinstance(subvalue, dict):
                        for subsubkey in subvalue:
                            multi_dict_items.append(
                                (f"{key}-{index}-{subsubkey}", subvalue[subsubkey])
                            )
                    elif isinstance(subvalue, list):
                        for subsubvalue in subvalue:
                            multi_dict_items.append((f"{key}-{index}", subsubvalue))
                    elif key in ["keywords"]:
                        multi_dict_items.append((f"{key}-{index}", kw_map[subvalue]))
                    else:
                        multi_dict_items.append((key, subvalue))
            elif isinstance(value, dict):
                for subkey, subvalue in value.items():
                    multi_dict_items.append((f"{key}-{subkey}", subvalue))
            else:
    ...
    def get_api1data(self, record: str) -> dict:
        ...
        kw_map = {
            "http://rdamsc.bath.ac.uk/thesaurus/subdomain235": "Earth sciences",
            "http://vocabularies.unesco.org/thesaurus/concept457": "Information/library standards",
            "http://vocabularies.unesco.org/thesaurus/concept4011": "Biological diversity",
        }

        dbdata = getattr(self, record)
        apidata = dict()
        apidata["identifiers"] = [{"id": f"msc:{record}", "scheme": "RDA-MSCWG"}]
        for key, value in dbdata.items():
            if key == "identifiers":
                apidata[key] += value
            elif key == "dataTypes":
        ...
        if related_entities:
            n = 5
            related_entities.sort(key=lambda k: k["id"][:n] + k["id"][n:].zfill(5))
            apidata["relatedEntities"] = related_entities
        return json.loads(json.dumps(apidata))
    ...
    def get_apidataset(self, table: str) -> t.List[dict]:
        ...
        i = 1
        while hasattr(self, f"{table}{i}"):
            apidataset.append(self.get_apidata(f"{table}{i}", with_embedded=False))
            i += 1
        return apidataset
            ...
            if record.startswith("rel"):
                ...
                while hasattr(self, f"rel{i}"):
                    ...
                    if test_rel["@id"] == rel_id:
                        ...
                        break
                    i += 1
            apirel = {"@id": rel_id, "uri": f"http://localhost/api2/rel/{rel_id[4:]}"}
            apirel.update(rel)
    ...
    def get_apirelset(self, inverse: bool = False) -> t.List[dict]:
        ...
        if inverse:
            ...
            for id in sorted(reldict.keys(), key=lambda k: k[:n] + k[n:].zfill(5)):
...
class UserDBActions(object):
    ...
    def write_db(self) -> None:
        """Writes main database file."""
        self._tables_to_file(["api_users"], self._app.config["USER_DATABASE_PATH"])
