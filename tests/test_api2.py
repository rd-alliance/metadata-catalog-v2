...
def test_main_get(client: FlaskClient, data_db: DataDBActions):
    ...
    ideal = json.dumps(
        {"apiVersion": api_version, "data": data_db.get_apidata("m1")}, sort_keys=True
    )
    ...
    assert response.status_code == 200
    ideal = json.dumps(
        {"apiVersion": api_version, "data": data_db.get_apidata("m3")}, sort_keys=True
    )
    actual = json.dumps(response.get_json(), sort_keys=True)
    assert ideal == actual
    ...
    if total > 10:
        ideal["data"]["nextLink"] = "http://localhost/api2/m?start=11&pageSize=10"
    actual = json.dumps(response.get_json(), sort_keys=True)
    ...
    response = client.get("/api2/m?start=2&page=10&pageSize=2", follow_redirects=True)
    assert response.status_code == 200
    actual = response.get_json()
    ...
    assert response.status_code == 200
    ideal = {"apiVersion": api_version, "data": data_db.rel3}
    ...
    if total > 10:
        ideal["data"]["nextLink"] = "http://localhost/api2/rel?start=11&pageSize=10"
    actual = json.dumps(response.get_json(), sort_keys=True)
    assert json.dumps(ideal, sort_keys=True) == actual
    ...
    for result in results:
        ...
        g1rel = None
    ideal = {"apiVersion": api_version, "data": g1rel}
    actual = json.dumps(response.get_json(), sort_keys=True)
    assert json.dumps(ideal, sort_keys=True) == actual
...
def test_term_get(client: FlaskClient, data_db: DataDBActions):
    ...
    assert response.status_code == 200
    ideal = json.dumps(
        {"apiVersion": api_version, "data": data_db.get_apidata("datatype1")},
        sort_keys=True,
    )
    actual = json.dumps(response.get_json(), sort_keys=True)
    assert ideal == actual
    ...
    assert response.status_code == 200
    ideal = json.dumps(
        {"apiVersion": api_version, "data": data_db.get_apiterm("location", 1)},
        sort_keys=True,
    )
    actual = json.dumps(response.get_json(), sort_keys=True)
    assert ideal == actual
...
def test_extract_values():
    ...
    assert rdamsc.api2.extract_values(
        record, deque(["Key2", "Subkey3", "Subsubkey3"])
    ) == ["V5", "V7"]
...
def test_passes_filter():
    ...
    assert rdamsc.api2.passes_filter(
        record, ["AND", ("Key5", (40, 42)), ("Key5", (41, 43))]
    )
    # - conditions are True, False
    assert not rdamsc.api2.passes_filter(
        record, ["AND", ("Key5", (40, 42)), ("Key5", (43, 45))]
    )
    assert rdamsc.api2.passes_filter(
        record, ["OR", ("Key5", (40, 42)), ("Key5", (43, 45))]
    )
    # - conditions are False, False
    assert not rdamsc.api2.passes_filter(record, ["OR", ("Key5", 40), ("Key5", 45)])
...
def test_parse_query():
    transforms = {
        ...
        "title=(Noun Verb) Adverb": [
            "OR",
            ["EXACTLY", ["OR", ("title", "Noun"), ("title", "Verb")]],
            (None, "Adverb"),
        ],
        "title=((Noun Verb) AND Adverb)": [
            "EXACTLY",
        ...
        "(Noun OR Verb) AND Adverb": [
            "AND",
            ["OR", (None, "Noun"), (None, "Verb")],
            (None, "Adverb"),
        ],
        "Noun OR (Verb AND Adverb)": [
            "OR",
            (None, "Noun"),
            ["AND", (None, "Verb"), (None, "Adverb")],
        ],
        "Noun OR ( Verb AND Adverb )": [
            "OR",
            (None, "Noun"),
    ...
    bad_strings = [
        ...
        "field:([Incomplete_range)field:(Incomplete_range])[Start TO Middle TO End]",
        "[Odd TO the Ends ]",
        "Incomplete escape \\",
        "Incomplete OR",
        "Incomplete AND",
...
def test_main_search(client: FlaskClient, data_db: DataDBActions):
    ...
    def mimic_output(items: list, query: str) -> dict:
        ...
        if total > 10:
            ideal["data"]["nextLink"] = f"http://localhost{query}&start=11&pageSize=10"
        return ideal
...
def test_thesaurus(client: FlaskClient, data_db: DataDBActions):
    ...
    ideal = {
        ...
        "data": {
            ...
            "skos:prefLabel": [{"@language": "en", "@value": "RDA MSC Thesaurus"}],
        },
    }
    ...
    ideal = {
        ...
        "data": {
            ...
            "@type": "skos:Concept",
            "skos:prefLabel": [
                {"@value": "Social and human sciences", "@language": "en"}
            ],
            "skos:narrower": [
            ...
            "skos:topConceptOf": [{"@id": "http://rdamsc.bath.ac.uk/thesaurus"}],
        },
    }
    ...
    ideal = {
        ...
        "data": {
            ...
            "@type": "skos:Concept",
            "skos:broader": [{"@id": "http://rdamsc.bath.ac.uk/thesaurus/domain6"}],
            "skos:narrower": [
            ...
            "skos:prefLabel": [{"@language": "en", "@value": "Materials and products"}],
        },
    }
    ...
    ideal = {
        ...
        "data": {
            ...
            "skos:prefLabel": [{"@language": "en", "@value": "Crops"}],
        },
    }
    ...
    assert test_data.get("data").get("items")[0] == {
        ...
        "@type": "skos:Concept",
        "skos:broader": [{"@id": "http://rdamsc.bath.ac.uk/thesaurus/domain2"}],
        "skos:narrower": [
...
def test_auth_api2(client: FlaskClient, app: Flask, user_db: UserDBActions):
    ...
    response = client.get("/api2/user/token", follow_redirects=True)
    ...
    response = client.post(
        "/api2/m", json={"name": "Compromised"}, follow_redirects=True
    )
    assert response.status_code == 401

    response = client.put(
        "/api2/g1", json={"name": "Compromised"}, follow_redirects=True
    )
    assert response.status_code == 401

    response = client.delete("/api2/t1", follow_redirects=True)
    assert response.status_code == 401

    response = client.put(
        "/api2/rel/c1", json={"input schemes": ["msc:m1"]}, follow_redirects=True
    )
    assert response.status_code == 401
...
def test_main_write(
    client: FlaskClient, auth_api: AuthAPIActions, data_db: DataDBActions
):
    ...
    ideal = json.dumps(
        {"apiVersion": api_version, "meta": {"conformance": "useful"}, "data": record},
        sort_keys=True,
    )
    actual = json.dumps(response.get_json(), sort_keys=True)
    assert ideal == actual
    ...
    ideal = json.dumps(
        {
            ...
            "error": {
                ...
                "errors": [
                    {"message": "Missing field: url.", "location": "$.locations[2]"},
                    {
                    ...
                    {"message": "Missing field: type.", "location": "$.locations[7]"},
                    {
    ...
    ideal = json.dumps(
        {
            ...
            "error": {
                ...
                "errors": [
                    {"message": "Missing field: id.", "location": "$.identifiers[0]"},
                    {"message": "Malformed DOI.", "location": "$.identifiers[1].id"},
                    {"message": "Malformed ROR.", "location": "$.identifiers[2].id"},
                    {
    ...
    ideal = json.dumps(
        {
            ...
            "error": {
                "message": errmess,
                "errors": [{"message": errmess, "location": "$.types[0]"}],
            },
        },
        sort_keys=True,
    )
    ...
    ideal = json.dumps(
        {
            ...
            "error": {
                ...
                "errors": [
                    {"message": "Malformed Handle.", "location": "$.identifiers[0].id"}
                ],
            },
        },
        sort_keys=True,
    ...
    ideal = json.dumps(
        {
            ...
            "error": {
                ...
                "errors": [
                    ...
                    {
                        # Depends on starter pack of terms
                        "message": "Invalid scheme: ROR. Valid schemes: DOI, Handle.",
    ...
    ideal = json.dumps(
        {
            ...
            "error": {
                "message": ideal_error,
                "errors": [
                    {"message": ideal_error, "location": "$.versions[0].number"}
                ],
            },
        },
        sort_keys=True,
    ...
    ideal = json.dumps(
        {
            ...
            "error": {
                "message": ideal_error,
                "errors": [
                    {"message": ideal_error, "location": "$.versions[0].valid.start"},
                    {"message": ideal_error, "location": "$.versions[0].valid.end"},
                    {
    ...
    ideal = json.dumps(
        {
            ...
            "error": {
                "message": ideal_error,
                "errors": [
                    {"message": ideal_error, "location": "$.versions[0].namespaces[0]"},
                    {
    ...
    assert_okay(response)
    ideal = json.dumps(
        {"apiVersion": api_version, "meta": {"conformance": "valid"}, "data": record},
        sort_keys=True,
    )
    actual = json.dumps(response.get_json(), sort_keys=True)
    assert ideal == actual
    ...
    assert response.status_code == 400
    result = response.get_json()
    assert result["error"]["errors"][0]["message"] == ("No such record: msc:g2.")
    ...
    patch = [{"op": "add", "path": "/funded schemes/0", "value": "msc:m3"}]
    credentials = f"Bearer {auth_api.get_token()}"
    response = client.patch(
        "/api2/invrel/g1",
        headers={"Authorization": credentials},
    ...
    for table in ["m", "g", "t", "e", "c"]:
        ...
        while hasattr(data_db, f"{table}{i}"):
            ...
            assert_okay(response)
            ideal = json.dumps(
                {"apiVersion": api_version, "data": data_db.get_apidata(f"{table}{i}")},
                sort_keys=True,
            )
            actual = json.dumps(response.get_json(), sort_keys=True)
            assert ideal == actual
    ...
    response = client.delete(
        "/api2/m4", headers={"Authorization": credentials}, follow_redirects=True
    )
    assert response.status_code == 204

    response = client.get("/api2/m4", follow_redirects=True)
    assert response.status_code == 404

    response = client.get("/api2/rel/m4", follow_redirects=True)
    assert response.status_code == 404

    response = client.get("/api2/invrel/m4", follow_redirects=True)
    assert response.status_code == 404
...
def test_rel_patch(
    ...
    patch = [{"op": "add", "path": "/parent schemes/-", "value": "msc:m1"}]
    credentials = f"Bearer {auth_api.get_token()}"
    response = client.patch(
        "/api2/rel/m42",
        headers={"Authorization": credentials},
    ...
    patch = [{"op": "add", "path": "/child schemes/-", "value": "msc:m1"}]
    credentials = f"Bearer {auth_api.get_token()}"
    response = client.patch(
        "/api2/invrel/m42",
        headers={"Authorization": credentials},
    ...
    assert result["error"]["errors"][0]["message"] == ("Predicate already missing.")
    ...
    assert result["error"]["errors"][1]["message"] == ("Value must be a single MSC ID.")
    assert result["error"]["errors"][1]["location"] == r"$[1].value"
    ...
    assert result["error"]["errors"][3]["message"] == ("Value must be a single MSC ID.")
    assert result["error"]["errors"][3]["location"] == r"$[3].value"

    assert result["error"]["errors"][4]["message"] == ("Predicate needs to be added.")
    assert result["error"]["errors"][4]["location"] == r"$[4].path"
    ...
    assert result["error"]["errors"][1]["message"] == ("Not a valid MSC ID: foobar.")
    assert result["error"]["errors"][1]["location"] == r"$[1].value"

    assert result["error"]["errors"][2]["message"] == ("No such record: msc:g42.")
    ...
    patch = [{"op": "add", "path": "/supported schemes", "value": ["msc:m1"]}]
    credentials = f"Bearer {auth_api.get_token()}"
    response = client.patch(
        "/api2/rel/t2",
        headers={"Authorization": credentials},
    ...
    patch = [
        {"op": "replace", "path": "/supported schemes", "value": ["msc:m2"]},
        {"op": "test", "path": "/supported schemes", "value": ["msc:m2"]},
        {"op": "replace", "path": "/supported schemes/0", "value": "msc:m3"},
        {"op": "test", "path": "/supported schemes/0", "value": "msc:m3"},
    ]
    credentials = f"Bearer {auth_api.get_token()}"
    response = client.patch(
        "/api2/rel/t2",
    ...
    patch = [{"op": "remove", "path": "/supported schemes/-"}]
    credentials = f"Bearer {auth_api.get_token()}"
    response = client.patch(
        "/api2/rel/t2",
        headers={"Authorization": credentials},
...
def test_term_write(
    ...
    assert result["error"]["errors"][0]["message"] == ("Missing field: label.")
    ...
    # Test bad applies:
    record = {"id": "contact", "label": "contact form", "applies": ["datatype"]}
    credentials = f"Bearer {auth_api.get_token()}"
    response = client.post(
        "/api2/location",
        headers={"Authorization": credentials},
    ...
    record = {"id": "ISNI", "label": "ISNI", "applies": ["organization"]}
    credentials = f"Bearer {auth_api.get_token()}"
    response = client.put(
        "/api2/id_scheme4",
        headers={"Authorization": credentials},
    ...
    credentials = f"Bearer {auth_api.get_token()}"
    response = client.delete(
        "/api2/datatype1", headers={"Authorization": credentials}, follow_redirects=True
    )
    assert response.status_code == 204
    ...
    response = client.get("/api2/id_scheme4", follow_redirects=True)
    assert response.status_code == 404
